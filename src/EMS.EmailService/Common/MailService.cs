...
{
    Task SendAsync(MailData mailData, CancellationToken ct = default);
...
public class MailService : IMailService
{
    ...
    public async Task SendAsync(MailData request, CancellationToken ct = default)
    {
        try
        {
    ...
    public string GetTemplate(string templateName)
    {
        ...
        string tmplFolder = Path.Combine(baseDirectory, "src/EMS.EmailService", "Common", "MailTemplates");
